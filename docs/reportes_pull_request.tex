...
\begin{itemize}[label=$\bullet$]
    \item \textbf{Grupo 4 - Scanning (\texttt{scanning.py}):} A la espera de Pull Request unificado. \textcolor{orange}{\textbf{(Advertencia: Fecha límite para mañana. Riesgo de tarea incumplida)}}.
    \item \textbf{Grupo 1 - Reconocimiento DNS (\texttt{dns\_recon.py}):} \textcolor{red}{\textbf{Rechazado / En corrección}} (Se solicitó restaurar archivos ajenos y arreglar el esquema de datos).
\end{itemize}
